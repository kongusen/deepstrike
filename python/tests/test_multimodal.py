from deepstrike._kernel import ContentPartObj, ModelMessage
...
def test_gemini_renders_url_image_file_data():
    msg = ModelMessage(role="user", content="", content_parts=[
