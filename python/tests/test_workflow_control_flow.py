...
def test_sub_agent_result_malformed_tool_args_does_not_brick():
    ...
    final = ModelMessage(role="assistant", content="", tool_calls=[ToolCall(id="t1", name="do", arguments='{"a": 1, "b')])
    ...
    final2 = ModelMessage(role="assistant", content="", tool_calls=[ToolCall(id="t1", name="do", arguments='{"a":1}')])
