...
from deepstrike._kernel import ModelMessage, ToolSchema  # type: ignore
...
class ReplayProvider(LLMProvider):
    ...
    def __init__(self, messages: Sequence[ModelMessage], opts: ReplayProviderOpts | None = None) -> None:
        self._messages: tuple[ModelMessage, ...] = tuple(messages)
