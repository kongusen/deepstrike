...
def deepseek(*, api_key, model=None, base_url=None, retry_config=None, protocol: Protocol | None = None):
...
def kimi(*, api_key, model=None, base_url=None, retry_config=None, protocol: Protocol | None = None, region: Region | None = None):
...
def qwen(*, api_key, model=None, base_url=None, retry_config=None, protocol: Protocol | None = None):
...
def glm(*, api_key, model=None, base_url=None, retry_config=None, protocol: Protocol | None = None, region: Region | None = None):
...
def minimax(*, api_key, model=None, base_url=None, retry_config=None, protocol: Protocol | None = None):
