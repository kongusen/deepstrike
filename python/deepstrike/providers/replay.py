...
class ReasoningReplayMixin:
    ...
    def remember_replay_fields(self, message: ModelMessage, fields: dict[str, Any]) -> None:
    ...
    def seed_provider_replay(self, content: str, tool_calls: list[ToolCall], replay: dict) -> None:
        if replay.get("protocol") == "openai-chat" and (
            ...
            self.remember_replay_fields(
                ModelMessage(role="assistant", content=content, tool_calls=tool_calls or None),
                dict(replay),
            )
