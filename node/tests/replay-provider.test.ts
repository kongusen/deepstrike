...
import type { ModelMessage, RenderedContext, ToolSchema, UsageEvent, TextDelta, ToolCallEvent } from "../src/types.js"
...
describe("ReplayProvider", () => {
  ...
  it("complete() returns the same ModelMessage that stream() would emit", async () => {
    const msg: ModelMessage = {
      role: "assistant",
      content: "answer",
