import { DurableMemory, InMemoryMemoryStore } from "../src/memory/public.js"
import type { Memory, MemoryRecord, MemoryScope, MemoryStore } from "../src/memory/public.js"
...
describe("spc_015-02: durable public Memory contract", () => {
  it("binds search/get/put/delete to one agent namespace without exposing the MemoryStore protocol", async () => {
