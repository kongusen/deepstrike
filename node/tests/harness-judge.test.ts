...
import type { LLMProvider, ModelMessage, RenderedContext, StreamEvent, ToolSchema, ProviderRunState } from "../src/types.js"
...
function evalProvider(verdictJson: string): { provider: LLMProvider; calls: () => number } {
  ...
  const provider: LLMProvider = {
    async complete(): Promise<ModelMessage> { return { role: "assistant", content: verdictJson } },
