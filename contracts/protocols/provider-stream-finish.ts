  ...
  adapters: [
    {
      ...
      fields: { envelope: { source: ["state"], target: ["events", "replay", "runStatePatch"] }, forbidden: [] },
    },
    {
      ...
      target: { type: "AdapterOutput", layer: "host", authority: "host-runtime" },
      fields: { envelope: { source: ["state", "final"], target: ["events", "replay", "runStatePatch"] }, forbidden: [] },
    },
    {
