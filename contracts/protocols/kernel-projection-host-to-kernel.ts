...
export const KERNEL_PROJECTION_HOST_TO_KERNEL_PROTOCOL: BoundaryProtocol = {
  ...
  validation: { mode: "behavioral-tests", reason: "Kernel projection tests cover snake-case fields, parsed arguments, and optional data handling.", testRefs: ["node/tests/kernel-projection-boundary.test.ts"] },
}
