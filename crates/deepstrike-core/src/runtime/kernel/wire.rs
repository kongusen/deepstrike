//! Canonical Kernel ABI — the single wire contract.
//!
...
/// The single supported ABI identity. Bindings export this core-owned value so host SDKs do not
/// maintain independent ABI constants or parallel contract names.
pub const ABI: u32 = 4;
