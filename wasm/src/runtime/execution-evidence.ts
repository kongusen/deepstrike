/**
 * P4 (0.2.64 Execution Evidence Plane): wasm mirror of the host-side object model connecting
 ...
 */
import type { ProviderWireEvidence } from "../types.js"
import type { NormalizedProviderUsage, ResolvedProviderRoute } from "../providers/request-plan.js"
...
export type CanonicalStopReason = "end_turn" | "max_tokens" | "stop_sequence" | "tool_use" | "content_filtered"
 ...
 */
export function tryNormalizeProviderUsage(usage: { inputTokens: number; outputTokens: number; cacheReadInputTokens?: number; cacheCreationInputTokens?: number; reasoningTokens?: number }): NormalizedProviderUsage | undefined {
  try {
