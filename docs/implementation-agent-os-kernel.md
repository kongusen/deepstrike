...
| Phase 1 / PR 2：Kernel ABI 固化 | 🟡 进行中 | Core ABI + Node/PyO3/WASM JSON ABI `KernelRuntime.step()` 已落地；Rust/Node SDK Runner 已迁入 step 驱动；PyO3 `KernelRuntime` 读侧 helpers 已补齐；Python Runner 待迁移 |
