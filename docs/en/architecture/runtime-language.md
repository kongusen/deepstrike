...
This glossary is normative for 0.2.73. It names what data means, who owns it, how it crosses a
boundary, and how it becomes durable history. The paired Chinese page is
[运行时语言](../../architecture/runtime-language.md).

## 0.2.73 language layers
...
| Host Runtime | **Context**, **ContextPlan**, **Capability**, **ModelRoute**, **Invocation**, **ProviderAttempt**, **Measurement**, **Evidence**, **Artifact**, **Evaluation**, **Promotion**, **ExecutionPlane** |
